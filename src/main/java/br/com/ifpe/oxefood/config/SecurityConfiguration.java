        ...
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
               ...
               .requestMatchers(HttpMethod.DELETE, "/api/produto/*").hasAnyAuthority(
                ...
                // .requestMatchers(HttpMethod.GET, "/api/produto").permitAll() (*TORNA A LISTA DE PRODUTOS UMA ROTA PUBLICA*)
                // .requestMatchers(HttpMethod.GET, "/api/produto/*").permitAll() (*RETORNA POR ID*)
                // .requestMatchers(HttpMethod.PUT, "/api/produto/*").permitAll() (*ALTERAR PRODUTO POR ID*)
